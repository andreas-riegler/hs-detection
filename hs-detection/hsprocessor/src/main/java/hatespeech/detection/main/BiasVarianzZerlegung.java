...
import weka.classifiers.BVDecomposeSegCVSub;
...
public class BiasVarianzZerlegung {
	...
	/** Debugging mode, gives extra output if true */
	  ...
	  /** The name of the data file used for the decomposition */
	  protected String m_ValidationFileName;
	  ...
	  public void setOptions(String[] options) throws Exception {
	    ...
	    String validationFile = Utils.getOption('v', options);
	    if (validationFile.length() == 0) {
	    	setValidationFileName(null);
	    }
	    else {
	    	setValidationFileName(validationFile);
	    }
	  ...
	  /**
	   * Sets the name of the validation file used for the decomposition
	   *
	   * @param dataFileName the data file to use
	   */
	  public void setValidationFileName(String dataFileName) {

	    m_ValidationFileName = dataFileName;
	  }

	  /**
	   * Get the name of the validation file used for the decomposition
	   *
	   * @return the name of the data file
	   */
	  public String getValidationFileName() {

	    return m_ValidationFileName;
	  }
	  ...
	  public void decompose() throws Exception {
	    ...
	    Instances validationData = null;
	    if(m_ValidationFileName != null) {
		    Reader validationDataReader = new BufferedReader(new FileReader(m_ValidationFileName));
		    validationData = new Instances(validationDataReader);
		    
		    if (m_ClassIndex < 0) {
		    	validationData.setClassIndex(validationData.numAttributes() - 1);
			    } else {
			    	validationData.setClassIndex(m_ClassIndex);
			    }
			    if (validationData.classAttribute().type() != Attribute.NOMINAL) {
			      throw new Exception("Class attribute must be nominal");
			    }
			    int numClasses = validationData.numClasses();

			    validationData.deleteWithMissingClass();
			    if (validationData.checkForStringAttributes()) {
...
//	    }
	    ...
	    if(m_ValidationFileName == null){
		    test = new Instances(data, m_TrainPoolSize, data.numInstances() - m_TrainPoolSize);
	    }
	    else {
	    	test = new Instances(validationData, 0, validationData.numInstances());
	    }
	  ...
	  public static void main(String [] args) {
	    ...
	    try {
	      BiasVarianzZerlegung bvd = new BiasVarianzZerlegung();
...
//	      bvd.setDataFileName("Bias_SMO_LIWC_Gesamt_Test.arff");
	      //Bis 53605
//	      bvd.setDataFileName("Bias_SMO_Best_Gesamt_Train_Test.arff");
//	      bis 2857
//	      bvd.setDataFileName("Bias_SMO_LIWC_Gesamt_Train_Test.arff");
	      SMO smo = new SMO();
	      smo.setC(0.37);
	      smo.setEpsilon(1.0e-9);
