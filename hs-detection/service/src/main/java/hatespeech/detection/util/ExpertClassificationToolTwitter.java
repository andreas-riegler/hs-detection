...
public class ExpertClassificationToolTwitter extends JFrame{
	...
	public ExpertClassificationToolTwitter(int min,int max)
	{
		initGUI();
	...
	public static void main(String[] args) {
		if(args.length==2)
		{
			ExpertClassificationToolTwitter exptClass=new ExpertClassificationToolTwitter(Integer.parseInt(args[0]),Integer.parseInt(args[1]));
